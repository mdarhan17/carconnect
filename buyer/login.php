...
if($_SERVER['REQUEST_METHOD']==='POST'){
  ...
  $stmt = mysqli_prepare($conn, "SELECT id,password,role FROM users WHERE email=? AND role='buyer' AND status='active' LIMIT 1");
...
<form class="form" method="POST" data-validate>
  ...
  <p class="muted" style="margin-top:10px">New? <a href="/carconnect/buyer/register.php">Register</a></p>
</form>
