...
if($_SERVER['REQUEST_METHOD']==='POST'){
  ...
  if(!$name || !$pass || !is_valid_email($email)){
    ...
    if(!mysqli_stmt_execute($stmt)){
      ...
      redirect("/carconnect/buyer/login.php");
    }
  }
}
?>
...
<form class="form" method="POST" data-validate>
  ...
  <div style="margin-top:12px"><button class="btn primary">Create Account</button></div>
  <p class="muted" style="margin-top:10px">Already? <a href="/carconnect/buyer/login.php">Login</a></p>
</form>
